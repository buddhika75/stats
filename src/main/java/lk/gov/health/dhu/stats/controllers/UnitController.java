...
import lk.gov.health.dhu.stats.entity.Unit;
...
import lk.gov.health.dhu.stats.sessionBeans.UnitFacade;
...
public class UnitController implements Serializable {
    ...
    @EJB
    private lk.gov.health.dhu.stats.sessionBeans.UnitFacade ejbFacade;
